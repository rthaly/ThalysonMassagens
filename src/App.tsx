...
import {
  ...
  BedDouble, Lock, Globe, Moon, Sun, Instagram, Award, Sparkles
} from 'lucide-react';
...
const CONFIG = {
  ...
  STORAGE_KEY: 'thaly_app_v16_elite',
  XP_TARGET: 300,
  REWARD_VAL: 30
};

// ==================================================================================
// 2. SISTEMA DE TRADUÇÃO COMPLETO (COPYWRITING FORTE)
// ==================================================================================

const TEXTS = {
  pt: {
    // Header & Intro
    welcome_title: "Renove suas energias.",
    welcome_subtitle: "Massagem profissional de alto nível no conforto do seu local.",
    ...
    // Serviços (Copy Persuasiva)
    choose_svc: "Escolha sua Jornada",
    svc_comp_name: "🔥 Experiência Completa",
    svc_comp_desc: "O ápice do relaxamento. Conexão total corpo e mente.",
    svc_comp_note: "Focado no seu prazer. Sem penetração/oral.",
    svc_comp_steps: [
      '1️⃣ Relaxante Muscular (Zero Tensão)', 
      '2️⃣ Corpo a Corpo (Sensitivo & Quente)', 
      '3️⃣ Tântrica (Finalização Manual Inclusa)'
    ],
    svc_comp_tag: "PREMIUM",
    
    svc_relax_name: "🍃 Massagem Relaxante",
    svc_relax_desc: "Alívio imediato de dores e stress.",
    svc_relax_note: "Protocolo 100% terapêutico. Sem toques íntimos.",
    svc_relax_steps: [
      '1️⃣ Foco em Nódulos e Dores', 
      '2️⃣ Movimentos Firmes e Técnicos', 
      '3️⃣ Revitalização Física'
    ],
    svc_relax_tag: "TERAPÊUTICA",

    // Extras
    personalize: "Turbine sua Sessão",
    ext_title: "Adicionais Exclusivos",
    ext_time: "Duração Estendida (1h30)",
    ext_time_sub: "Mais tempo para relaxar",
    ext_touch: "Interatividade Total",
    ext_touch_sub: "Troca de energia permitida",
    ext_touch_warn: "Massagista fica de cueca",
    ext_aroma: "Aromaterapia Premium",
    ext_aroma_sub: "Óleos essenciais importados",
    ...
    lbl_addr: "Endereço (Rua/Av)",
    lbl_num: "Número",
    lbl_dist: "Bairro",
    lbl_comp: "Complemento",
    
    uber_warn: "Taxa de deslocamento (Uber) não inclusa. Calculada no WhatsApp.",
    
    // Resumo e Pagamento
    review_title: "Revisão do Pedido",
    base_val: "Serviço Base",
    coupon_lbl: "Desconto Aplicado",
    add_coupon: "Adicionar Cupom",
    total_lbl: "Valor Total",
    ...
    use: "USAR",
    level_title: "Nível Fidelidade",
    xp_text: "pontos acumulados",
    next_reward: "Faltam",
    next_reward_suf: "pontos para ganhar R$ 30,00 OFF",
    gift_banner_title: "Presente de Boas-vindas!",
    gift_banner_sub: "Toque para resgatar seu cupom de 1ª vez.",

    // Mensagens de Sucesso/Zap
    success_title: "Solicitação Recebida!",
    success_msg: "Seu pedido está no meu WhatsApp. Aguarde eu calcular o Uber para finalizarmos.",
    new_book: "Fazer Novo Pedido",
    ...
    zap_date: "Data",
    zap_loc: "Local",
    zap_finance: "Financeiro",
    zap_uber: "Uber (A Calcular)",
    zap_pay: "Pagamento",
    zap_obs: "Obs: +18 Confirmado"
  },
  en: {
    welcome_title: "Renew Your Energy.",
    welcome_subtitle: "High-level professional massage in the comfort of your place.",
    your_name: "How should I call you?",
    name_placeholder: "Enter your name...",
    health_check: "I am 18+ and healthy.",
    start_btn: "View Experiences",
    
    choose_svc: "Choose Your Journey",
    svc_comp_name: "🔥 Complete Experience",
    svc_comp_desc: "The peak of relaxation. Total body & mind connection.",
    svc_comp_note: "Pleasure focused. No penetration/oral.",
    svc_comp_steps: [
      '1️⃣ Muscle Relax (Zero Tension)', 
      '2️⃣ Body-to-Body (Sensitive & Hot)', 
      '3️⃣ Tantra (Manual Finish Included)'
    ],
    svc_comp_tag: "PREMIUM",
    
    svc_relax_name: "🍃 Relaxing Massage",
    svc_relax_desc: "Immediate relief from pain and stress.",
    svc_relax_note: "100% therapeutic protocol. No intimate touch.",
    svc_relax_steps: [
      '1️⃣ Focus on Knots & Pain', 
      '2️⃣ Firm & Technical Movements', 
      '3️⃣ Physical Revitalization'
    ],
    svc_relax_tag: "THERAPEUTIC",

    personalize: "Boost Your Session",
    ext_title: "Exclusive Add-ons",
    ext_time: "Extended Time (1h30)",
    ext_time_sub: "More time to relax",
    ext_touch: "Total Interactivity",
    ext_touch_sub: "Energy exchange allowed",
    ext_touch_warn: "Masseur stays in underwear",
    ext_aroma: "Premium Aromatherapy",
    ext_aroma_sub: "Imported essential oils",
    ...
    base_val: "Base Service",
    coupon_lbl: "Discount Applied",
    add_coupon: "Add Coupon",
    total_lbl: "Total Value",
    
    pay_title: "Payment (On Site)",
    money: "Cash",
    card: "Card",
    pix: "Pix",
    ...
    use: "USE",
    level_title: "Loyalty Level",
    xp_text: "points accumulated",
    next_reward: "Need",
    next_reward_suf: "points to get R$ 30.00 OFF",
    gift_banner_title: "Welcome Gift!",
    gift_banner_sub: "Tap to redeem your 1st-time coupon.",

    success_title: "Request Received!",
    success_msg: "Your order is on my WhatsApp. Wait for me to calculate the Uber fee to finalize.",
...
const REVIEWS_DATA = {
  ...
  en: [
    { t: "The best massage I've ever had. The progression is perfect.", a: "Tiago", s: 5 },
    { t: "Rare professionalism. Explained everything beforehand.", a: "Robert", s: 5 },
    { t: "I went in stiff and left feeling light. Worth every penny.", a: "Peter H.", s: 5 },
    { t: "Firm hands, strong grip. The cream makes a difference.", a: "Curious", s: 5 },
    { t: "His touch is addictive. The finish was absurd.", a: "Anonymous", s: 5 },
    { t: "Total feeling of freedom. Highly recommend.", a: "Kyle", s: 5 }
  ]
};
...
export default function App() {
  ...
  const T = TEXTS[lang]; // Atalho para tradução atual
  ...
  const finalize = () => {
      ...
      if(booking.locationType === 'motel') {
          ...
          locStr = `${T.btn_home}: ${addr.street}, ${addr.number}\n${T.lbl_dist}: ${addr.district} ${addr.comp ? `(${addr.comp})` : ''}`;
...
💆 ${T.zap_service}: ${svcName}
📅 ${T.zap_date}: ${new Date(booking.date).toLocaleDateString('pt-BR')} @ ${booking.time}

✨ ${extrasTxt ? extrasTxt : 'No Extras'}
...
💳 ${T.zap_pay}: ${booking.payment?.toUpperCase()}
`.trim();
  ...
  return (
    <div className={`min-h-screen font-sans pb-48 transition-colors duration-300 ${isDark ? 'bg-black text-white selection:bg-green-500 selection:text-black' : 'bg-gray-50 text-gray-900 selection:bg-black selection:text-white'}`}>
      ...
      <header className={`fixed top-0 w-full z-40 backdrop-blur-xl border-b transition-colors duration-300 ${isDark ? 'bg-black/80 border-white/5' : 'bg-white/80 border-gray-200'}`}>
         <div className="px-5 py-4 flex justify-between items-center">
             ...
             <div className="flex gap-2">
                 <button onClick={() => window.open(CONFIG.INSTAGRAM, '_blank')} className={`p-2 rounded-full border ${isDark ? 'bg-[#111] border-[#222]' : 'bg-white border-gray-200'}`}><Instagram size={20}/></button>
                 <button onClick={() => setLang(lang === 'pt' ? 'en' : 'pt')} className={`p-2 rounded-full border ${isDark ? 'bg-[#111] border-[#222]' : 'bg-white border-gray-200'}`}><Globe size={20}/></button>
                 <button onClick={() => setIsDark(!isDark)} className={`p-2 rounded-full border ${isDark ? 'bg-[#111] border-[#222]' : 'bg-white border-gray-200'}`}>{isDark ? <Sun size={20}/> : <Moon size={20}/>}</button>
      ...
      {/* MENU & WALLET */}
      {menuOpen && <div className="fixed inset-0 z-50 flex justify-end"><div className="absolute inset-0 bg-black/80" onClick={()=>setMenuOpen(false)}></div><div className={`relative w-72 h-full border-l p-6 shadow-2xl animate-slide-in ${isDark ? 'bg-[#111] border-[#222]' : 'bg-white border-gray-200'}`}><button onClick={()=>setMenuOpen(false)} className="mb-8"><X/></button><div className={`${isDark ? 'bg-[#222]' : 'bg-gray-100'} p-4 rounded-xl mb-4`}><div className="flex justify-between items-center mb-2"><span className="text-xs font-bold uppercase">{T.level_title}</span><span className="text-green-500 font-bold text-xl">{level}</span></div><div className="h-2 bg-gray-600 rounded-full overflow-hidden mb-2"><div className="h-full bg-green-500" style={{width:`${progress}%`}}></div></div><p className="text-[10px] opacity-70">{T.next_reward} <span className="font-bold text-green-500">{nextXp}</span> {T.next_reward_suf}</p></div><button className={`w-full py-4 rounded-xl font-bold text-sm mb-2 ${isDark ? 'bg-[#222]' : 'bg-gray-100'}`} onClick={() => setWalletOpen(true)}>{T.wallet_title}</button><button className={`w-full py-4 rounded-xl font-bold text-sm ${isDark ? 'bg-[#222]' : 'bg-gray-100'}`} onClick={()=>{if(navigator.share)navigator.share({url:window.location.href})}}>{T.menu_share}</button></div></div>}
      ...
      <main className="pt-24 px-5 max-w-md mx-auto animate-fade-in">
        ...
        {step === 0 && (
            <>
                ...
                <h2 className="text-3xl font-black mb-1 tracking-tight">{T.welcome_title}</h2>
                <p className={`text-sm mb-8 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>{T.welcome_subtitle}</p>
                ...
                <div className="mb-20">
                    <p className={`text-[10px] font-bold uppercase mb-3 ml-1 ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>{T.reviews_title}</p>
                    <ReviewCarousel reviews={REVIEWS_DATA[lang]} isDark={isDark} />
                </div>
        ...
        {step === 1 && (
            <>
                ...
                <p className={`text-[10px] font-bold uppercase mb-3 ml-1 ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>{T.date_time}</p>
