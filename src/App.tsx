...
// ==================================================================================
// DATA & COPY STRATEGY (CLEAR BOUNDARIES & TANTRIC FOCUS)
// ==================================================================================
...
const getData = (lang: 'pt' | 'en') => {
  ...
  return {
    levels: [
      ...
      { level: 3, xpNeeded: 350, reward: 30, title: isEn ? "Conscious Body" : "Despertar Tântrico" },
      { level: 4, xpNeeded: 800, reward: 50, title: isEn ? "Plenitude" : "Plenitude Tântrica" }
    ],
    services: [
      { id: 'pes', category: 'express', min: 40, price: p.pes, icon: "user-check", tag: isEn ? "FOOT RELIEF" : "ALÍVIO PÉS", title: isEn ? "Foot Reflexology" : "Reflexologia Podal", desc: isEn ? "Complete relief for tired feet." : "Alívio completo e relaxamento profundo começando pelos pés.", details: isEn ? "1. Foot reflexology\n2. Deep pressure points" : "1. Reflexologia focada na sola dos pés.\n2. Pressão em pontos de tensão.\n3. Alívio imediato do cansaço mental e físico." },
      
      { id: 'relaxante', category: 'relax', min: 40, price: p.relax, icon: "user-check", tag: isEn ? "MUSCLE RELIEF" : "ALÍVIO MUSCULAR", title: isEn ? "Classic Massage" : "Massagem Clássica", desc: isEn ? "Full body massage focused on pain relief. No intimate touches." : "Massagem corporal focada em soltar nós e preparar o corpo para o relaxamento profundo da mente.", details: isEn ? "1. Full body relaxing massage.\n2. Deep tension relief.\n3. Professional session only." : "1. Massagem no corpo todo (costas, pernas, braços).\n2. Foco em nós e tensões acumuladas.\n3. Zero toques íntimos.\n4. Descompressão total da rotina." },
      
      { id: 'sensitiva', category: 'final', min: 60, price: p.sens, icon: "sparkles", tag: isEn ? "SENSUAL START" : "DESPERTAR", title: isEn ? "Sensory Massage" : "Massagem Sensitiva", desc: isEn ? "Classic massage followed by gentle touches, ending with a manual release." : "Toques sutis e tântricos que despertam a sensibilidade corporal. Finalização manual para alívio e liberação total de energia.", details: isEn ? "1. Classic body massage.\n2. Sensory awakening.\n3. Manual release (Lingam)." : "1. Massagem para soltar o peso do corpo.\n2. Toques sutis que despertam a energia tântrica.\n3. Foco na região íntima (Lingam) no terço final.\n4. Finalização manual para o ápice do relaxamento.\n*(Obs: Não há sexo ou penetração)*" },
      
      { id: 'mista', category: 'final', min: 60, price: p.titan, icon: "zap", tag: isEn ? "SKIN TO SKIN" : "PELE A PELE", title: isEn ? "Fusion Experience" : "Experiência Fusion", desc: isEn ? "Body-to-body contact (I wear underwear). Intense stimulation and manual ending." : "O equilíbrio perfeito. Massagem profunda e contato corpo a corpo intenso para despertar sua energia. Finalização tântrica.", details: isEn ? "1. Classic massage.\n2. Skin to skin contact.\n3. Manual release." : "1. Massagem clássica para tirar as travas.\n2. Contato físico muito próximo (atendo de cueca).\n3. Estímulo tântrico focado em entrega.\n4. Finalização tântrica manual (Lingam) poderosa.\n*(Obs: Sem ato sexual)*" },
      
      { id: 'reversa', category: 'final', min: 60, price: p.reversa, icon: "refresh-cw", tag: isEn ? "YOUR CONTROL" : "SEU CONTROLE", title: isEn ? "Reverse Massage" : "Massagem Reversa", desc: isEn ? "I start the massage, then you take control." : "Começo relaxando seu corpo tântricamente. Depois, você assume o controle e dita o ritmo da troca de energia.", details: isEn ? "1. Classic massage (approx. 30 min).\n2. Control passes to you.\n3. Freedom to guide the rhythm.\n4. Mutual ending." : "1. Massagem inicial relaxante (aprox. 30 min).\n2. O controle da sessão passa para você.\n3. Liberdade total para guiar o ritmo, a intensidade e os toques.\n4. Finalização intensa e libertadora.\n*(Obs: Sem ato sexual/penetração)*" },
      
      { id: 'nuru', category: 'final', min: 60, price: p.nuru, icon: "star", popular: true, tag: isEn ? "PREMIUM SLIDE" : "O ÁPICE TÂNTRICO", title: isEn ? "Nuru Massage" : "Massagem Nuru (Com Gel)", desc: isEn ? "Full body sliding with gliding gel. Total surrender with an intense manual ending." : "Muito gel que desliza pelo corpo todo. Entrega e relaxamento tântrico extremo com estímulo prolongado no Lingam.", details: isEn ? "1. Naked sliding massage.\n2. Special gliding gel.\n3. Lingam massage ending." : "1. Atendimento feito inteiramente sem roupas.\n2. Deslizamento fluido e contínuo corpo a corpo com gel especial.\n3. Sensibilidade máxima elevada pelo gel.\n4. Finalização manual demorada para esvaziar a mente.\n*(Obs: Foco no seu relaxamento e prazer manual, sem penetração).*." },
      
      { id: 'depilacao', category: 'care', min: 60, price: p.depil, icon: "scissors", tag: isEn ? "AESTHETICS" : "ESTÉTICA", title: isEn ? "Body Hair Trim" : "Aparo de Pelos", desc: isEn ? "Body hair maintenance with clippers." : "Aparo dos pelos corporais com máquina para higiene e estética (pente 0 e 3).", details: isEn ? "1. Trim with clippers." : "1. Aparo com máquina (pente zero ou três).\n2. Corpo limpo e estética preparada para o atendimento." }
    ] as ServiceItem[],
    
    plans: [
      { id: 'pack_classic4', type: 'pack', title: isEn ? "Pain-Free Month (4x)" : "Mês Sem Dor (4x)", price: p.pack_classic4.v, fullPrice: p.pack_classic4.full, savings: p.pack_classic4.save, desc: isEn ? "Relief with zero intimate touches." : "Alívio muscular contínuo. 1x por semana.", details: isEn ? "4x Classic Massage" : "4x Massagem Clássica\nAgendamento flexível 1x por semana.", tag: "CLÁSSICO", icon: "calendar" },
      { id: 'pack_tantric', type: 'pack', title: isEn ? "Tantric Journey (3x)" : "Jornada Tântrica (3x)", price: p.pack_tantric.v, fullPrice: p.pack_tantric.full, savings: p.pack_tantric.save, desc: isEn ? "Three encounters escalating intimacy." : "Três sessões para escalar o nível de relaxamento e energia tântrica.", details: isEn ? "Sensory + Fusion + Nuru" : "1x Sensitiva (Despertar)\n1x Fusion (Pele a pele)\n1x Nuru (Deslize com gel e entrega total)", tag: "IMERSÃO", icon: "heart" },
    ] as ServiceItem[],
    ...
    faq: [
      { q: isEn ? "Is there sex/penetration?" : "Rola sexo ou penetração (Programa)?", a: isEn ? "No. Strictly therapeutic with a manual ending." : "Não. As sessões focadas em finalização utilizam apenas técnicas de estímulo manual tântrico (massagem no Lingam) focadas no seu alívio, de forma muito intensa. Não é realizado penetração ou sexo." },
      { q: isEn ? "Is it discreet?" : "Sou casado/sigiloso, o atendimento é discreto?", a: isEn ? "Absolute discretion guaranteed." : "Sim. A discrição é absoluta. O atendimento na sua residência, hotel ou na minha suíte garante privacidade total. Ninguém além de mim e de você saberá do atendimento. Seus dados são apagados do histórico." },
      { q: isEn ? "Where is the meeting?" : "Onde o atendimento é realizado?", a: isEn ? "I come to you or a hotel." : "Eu vou até você (residência ou hotel) ou você pode vir na minha Suíte Privada na Bela Vista." },
      { q: isEn ? "Ashamed of my body?" : "Tenho vergonha do meu corpo, o que eu faço?", a: isEn ? "No judgments here." : "Esqueça isso. O ambiente é seguro e livre de preconceitos. Não importa sua idade ou formato de corpo. O foco é exclusivamente cuidar de você, entregar prazer e promover seu relaxamento." }
    ],
    rules: [
      ...
      { icon: "hand", title: isEn ? "Boundaries (No Sex)" : "Limites Claros (Sem Ato Sexual)", description: isEn ? "Manual release only." : "As sessões utilizam apenas técnicas de estímulo manual tântrico. Sexo e penetração não fazem parte do serviço." },
      { icon: "shower", title: isEn ? "Hygiene" : "Higiene Básica", description: isEn ? "Shower before." : "Um banho quente antes de eu iniciar o atendimento é essencial para o conforto e respeito." }
    ],
    text: {
      welcome: isEn ? "Welcome," : "Olá,",
      welcome_anon: isEn ? "allow yourself." : "permita-se relaxar.",
      choose_sub: isEn ? "Choose your care." : "Espaço seguro, sigiloso e livre de julgamentos para você soltar a tensão e viver um relaxamento tântrico profundo.",
      ...
      toast_fill_addr: isEn ? "Fill the address." : "Preencha o local do atendimento.",
      ...
      details_label: isEn ? "WHAT TO EXPECT:" : "O QUE ESPERAR DA SESSÃO:",
      select_time_title: isEn ? "When?" : "Qual a data do atendimento?",
      location_title: isEn ? "Where?" : "Onde o atendimento será realizado?",
      extras_title: isEn ? "Add-ons" : "Deseja adicionar algo a mais?",
      ...
      terms_title: isEn ? "Rules & Discretion" : "Regras e Acordos Inegociáveis",
      ...
      rules_complete: isEn ? "Agreements" : "Acordos Inegociáveis",
      uber_notice: isEn ? "Travel fee confirmed on WhatsApp." : "Importante: A taxa de Uber até você será calculada no WhatsApp.",
      motel_note: isEn ? "Address sent after booking." : "Perfeito! O endereço da minha suíte (Bela Vista) será enviado no WhatsApp.",
      ...
      share_text: isEn ? 'Great massage therapist.' : 'Recomendo esse terapeuta para aliviar a tensão em SP. Muito focado e discreto.',
      ...
      cart_title: isEn ? "Cart" : "A Sua Seleção",
      time_rush: isEn ? "Rush" : "Pico",
      loc_home: isEn ? "Home" : "Na sua residência",
      loc_motel: isEn ? "My Suite" : "Na minha Suíte",
      loc_hotel: isEn ? "Hotel" : "Em Hotel",
      summary_title: isEn ? "Summary" : "Resumo do seu Atendimento",
      summary_items: isEn ? "SERVICES" : "A EXPERIÊNCIA SELECIONADA",
      ...
      terms_read: isEn ? "Read rules" : "Toque para ler as regras e limites",
...
const FloatingWhatsApp = memo(({ isDark, lang, onClick }: any) => {
  ...
  const msg = lang === 'en' ? 'Hi! Need any help?' : 'Oi, tem alguma dúvida sobre os horários?';
...
export default function App() {
  ...
  const handleToggleCartItem = useCallback((item: ServiceItem) => {
    ...
    setBooking(prev => {
      ...
      const newCart = exists ? prev.cart.filter(c => c.id !== item.id) : [...prev.cart, item];
      
      if (!exists) {
        // Auto-scroll inteligênte para facilitar o clique no "Continuar"
        setTimeout(() => {
          window.scrollTo({ top: document.body.scrollHeight, behavior: 'smooth' });
        }, 150);
      }

      return { ...prev, cart: newCart, payment: '', termsAccepted: false };
    });
  ...
  const generateWhatsAppMsg = () => {
    ...
    else if (booking.locationType === 'motel') locTxt = `🔑 *Na sua Suíte*\n  (Endereço enviado após confirmação)`;
  ...
  const categoryConfig = [
    ...
    { id: 'final', title: lang === 'en' ? "Tantric Journey" : "Terapia Tântrica & Prazer", icon: 'sparkles', desc: lang === 'en' ? "Sensory focus with manual release." : "Jornada sensorial com liberação e energia." },
