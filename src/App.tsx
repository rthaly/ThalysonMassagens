...
const getData = (lang: 'pt' | 'en') => {
  ...
  const p = {
    ...
    // Todos os pacotes reformulados de acordo estritamente com suas descrições e com desconto real de exatamente 20%:
    // 1. Alívio de Rotina (2x): 1x Pés (110) + 1x Clássica (180) + Aroma Bônus (17) = 307 - 20% = 245
    pack_basic: { v: 245, full: 307, save: 62 },     
    // 2. Pacote Essencial (2x): 1x Clássica (180) + 1x Sensorial (200) = 380 - 20% = 304
    pack1: { v: 304, full: 380, save: 76 },          
    // 3. Renovação Completa (2x): 1x Aparo (107) + 1x Fusion (250) + +30 min Bônus (77) = 434 - 20% = 347
    pack_glow: { v: 347, full: 434, save: 87 },      
    // 4. Combo Recuperação (2x): 2x Atletas Crossfit (400) + Pomada Foco Dores Bônus (17) = 417 - 20% = 333
    pack_muscle: { v: 333, full: 417, save: 84 },    
    // 5. Combo Conexão (2x): 1x Fusion (250) + 1x Reversa (300) = 550 - 20% = 440
    pack2: { v: 440, full: 550, save: 110 },         
    // 6. Clássica Semanal (4x) [NOVO]: 4x Clássica no mês (1 por semana - 100% sem toques sensoriais) = 720 - 20% = 576
    pack_classica_4x: { v: 576, full: 720, save: 144 },
    // 7. Pacote Renovar (3x): 1x Naturista (197) + 1x Fusion (250) + 1x Nuru (350) = 797 - 20% = 637
    pack3: { v: 637, full: 797, save: 160 },         
    // 8. Jornada Completa (3x): 1x Sensorial (200) + 1x Fusion (250) + 1x Nuru (350) = 800 - 20% = 640
    pack_ultimate: { v: 640, full: 800, save: 160 }, 
