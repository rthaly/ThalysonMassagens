...
const ReviewCard = memo(({ review, isDark }: { review: Review; isDark: boolean }) => (
  <article className={`w-full h-full p-5 md:p-6 rounded-2xl transition-all duration-300 hover:-translate-y-1 border ${isDark ? 'bg-zinc-900/60 border-zinc-800' : 'bg-white border-slate-200 shadow-md'}`}>
...
const getData = (lang: string) => {
  ...
  const p = {
    relax: getPrice(160), // Ajustado para 160
    sens: getPrice(175),
    titan: getPrice(205),
    nuru: getPrice(320),
    depil: getPrice(110),
    packRelax: { v: getPrice(540), full: getPrice(640), save: getPrice(100) }, // 4x160=640 - Oferecido por 540
    packTri: { v: getPrice(525), full: getPrice(615), save: getPrice(90) }, // 3x205=615 - Oferecido por 525
    packMix: { v: getPrice(640), full: getPrice(760), save: getPrice(120) }, // 2x175+2x205=760 - Oferecido por 640
    packSupreme: { v: getPrice(580), full: getPrice(685), save: getPrice(105) }, // 320+160+205=685 - Oferecido por 580
    extras: {
          ...
          <header className="pt-12 pb-6 flex items-start justify-between">
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2 text-[10px] text-blue-500 font-black uppercase tracking-widest mt-2 font-inter">
                ...
                {user.ordersCount || 83} Sessões Realizadas
              </div>
            </div>
            <button
          ...
          {step === 0 && (
            <section className="space-y-12 animate-fade-in">
              ...
              <div className="py-12 relative group">
                ...
                <div
                  id="reviews-slider"
                  className="flex overflow-x-auto snap-x snap-mandatory scrollbar-hide scroll-smooth pb-6 -mx-4 px-4"
                  style={{ 
                    scrollbarWidth: 'none',
                ...
                >
                  {DATA.reviews.map((r, i) => (
                    <div key={i} className="snap-center flex-shrink-0 w-[280px] md:w-[320px] mr-4 last:mr-0">
