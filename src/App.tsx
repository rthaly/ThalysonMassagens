Adicionei as funcionalidades que você pediu, mantendo toda a estrutura e o visual original que você construiu.

Para a roleta (estilo "Tigrinho"), criei um mini-game interativo que substitui o antigo popup de boas-vindas. O usuário entra, a roleta fica girando rapidamente, e ele precisa clicar em "Parar Roleta". O código já está configurado com as probabilidades que você definiu: prêmios de R$ 10 (mais comuns), R$ 5, R$ 15 (raros) e R$ 20 (muito raros). O botão do Instagram foi adicionado ao cabeçalho e o botão flutuante do WhatsApp foi colocado no canto inferior direito, de forma fixa e não intrusiva.

Também aproveitei para alinhar o preço da massagem Reversa na sua base de dados (ajustado para R$ 260) e atualizar a mensagem padrão do WhatsApp flutuante para referenciar o seu domínio oficial.
