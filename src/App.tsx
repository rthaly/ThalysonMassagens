...
/**
 * ==================================================================================
 * THALYSON APP OS v16.2 - MOTEL UPDATE
 * ==================================================================================
 * AJUSTES:
 * 1. [TEXT] Alteração de "Motel" para "Suíte (Motel)".
 * 2. [LOGIC] Texto explicativo sobre taxa de suíte paga pelo cliente no local.
 * 3. [FLOW] Detalhes financeiros de motel alinhados para fechar no WhatsApp.
 */
...
• FINISH: You cum at the end, no rush.`
        ...
        text: {
            ...
            // ==================================================================================
            // ATUALIZAÇÃO 1: Texto explicativo da Suíte/Motel
            // ==================================================================================
            ...
            zap: {
              ...
              hotel: "Hotel",
              // ==================================================================================
              // ATUALIZAÇÃO 2: Nome da categoria Motel
              // ==================================================================================
...
export default function App() {
  ...
  const generateWhatsAppLink = () => {
    ...
    if(booking.locationType === 'home') {
        ...
        // ==================================================================================
        // ATUALIZAÇÃO 3: Mensagem do Zap ajustada para Suíte/Motel
        // ==================================================================================
