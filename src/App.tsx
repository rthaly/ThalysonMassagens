...
const getFullReviews = (lang: 'pt' | 'en'): Review[] => {
  return [
    ...
    // Novos (Focados em finalização/experiência completa)
    { n: "Marcos", loc: "Pinheiros - SP", t: "A massagem começa super relaxante e a finalização é de outro mundo. O corpo inteiro treme de prazer. Vale cada centavo investido.", serv: "Experiência Fusion", s: 5 },
    { n: "Felipe", loc: "Consolação - SP", t: "A Sensorial me levou a um nível de relaxamento absurdo, a construção do tesão é gigante e o gozo no final me deixou leve por dias.", serv: "Massagem Sensorial", s: 5 },
    { n: "Tiago", loc: "Jardins - SP", t: "Atendimento impecável. Ele ficar de cueca e sentir o contato corpo a corpo na Fusion me deixou louco de tesão. Finalização deliciosa.", serv: "Experiência Fusion", s: 5 },
    { n: "Roberto", loc: "Santa Cecília - SP", t: "A Reversa foi exatamente o que eu precisava. Ser tocado, relaxar, e depois tocar o corpo dele, e gozarmos juntos... uma experiência inesquecível.", serv: "Massagem Reversa", s: 5 },
    { n: "Carlos", loc: "Paulista - SP", t: "Escolhi a postura ativa e foi a melhor decisão. Ele sabe exatamente como dominar. O tesão bateu forte do início ao fim com uma finalização absurda.", serv: "Massagem Sensorial + Postura Ativa", s: 5 },
    { n: "André", loc: "Bela Vista - SP", t: "Tirou toda a dor das minhas costas primeiro, e quando mudou o ritmo e a respiração dele chegou perto, não aguentei. Gozei muito, indico pra todos.", serv: "Experiência Fusion", s: 5 },
    { n: "Leandro", loc: "Vila Mariana - SP", t: "Eu tava muito tenso com o trabalho. A massagem tirou 100% do estresse e terminar a sessão esvaziando a mente com a finalização foi perfeito.", serv: "Massagem Sensorial", s: 5 },
    { n: "Pedro", loc: "Moema - SP", t: "A Nuru é espetacular. Aquele corpo quente e cheio de gel deslizando no meu... minhas pernas ficaram bambas e a finalização foi extremamente intensa.", serv: "Massagem Nuru", s: 5 },
    { n: "Rafael", loc: "Itaim Bibi - SP", t: "Eu adoro o toque. A meia hora que massageei ele na Reversa me deixou subindo pelas paredes. Terminar e gozar juntos foi mágico.", serv: "Massagem Reversa", s: 5 },
    { n: "Marcelo", loc: "Centro - SP", t: "Mãos firmes na clássica no começo pra relaxar. Quando a parte sensorial começou, cada arrepio me preparava mais. O gozo final foi de revirar os olhos.", serv: "Massagem Sensorial", s: 5 }
  ];
};
...
const getData = (lang: 'pt' | 'en') => {
  ...
  return {
    ...
    services: [
      ...
      { id: 'sensitiva', category: 'final', min: 60, price: p.sens, icon: "sparkles", tag: isEn ? "REDUCES ANXIETY" : "TIRA A ANSIEDADE", title: isEn ? "Sensory Massage" : "Massagem Sensorial", desc: isEn ? "Starts with a relaxing full-body classic massage, then subtle touches that give you shivers and a mind-blowing climax." : "Começa com uma clássica relaxante no corpo todo para você derreter. Depois, toques sutis que causam arrepios e uma finalização intensa que desliga a sua mente.", details: isEn ? "Step 1: Full body relaxing classic massage\nStep 2: Subtle shiver-inducing stimuli\nStep 3: Intense climax (gozo)" : "1. Início com massagem clássica no corpo todo para soltar as tensões e relaxar os músculos.\n2. Estímulos super leves usando as mãos e a respiração que arrepiam o corpo inteiro.\n3. Construção do tesão aos poucos, focada em deixar você completamente envolvido.\n4. Finalização manual focada numa liberação intensa de prazer (gozo)." },
      { id: 'mista', category: 'final', min: 60, price: p.titan, icon: "zap", tag: isEn ? "BEST OF BOTH WORLDS" : "O MELHOR DOS 2", title: isEn ? "Fusion Experience" : "Experiência Fusion", desc: isEn ? "First a classic massage to relieve pain. Then I strip to my underwear, skin-to-skin contact, and an unforgettable climax." : "A mais completa: primeiro a clássica para tirar a dor das costas. Depois o clima esquenta, eu atendo apenas de cueca e te levo a um tesão absurdo com gozo no final.", details: isEn ? "Step 1: Classic back massage\nStep 2: I attend in my underwear\nStep 3: Skin-to-skin and intense release" : "1. Começa com a massagem clássica e relaxante no corpo todo para soltar os músculos travados.\n2. Muda o ritmo: eu fico apenas de cueca e o calor aumenta, despertando seus sentidos.\n3. Contato corpo a corpo íntimo, respiração perto da nuca e pura provocação.\n4. Termina com uma estimulação quente e um gozo intenso para zerar o estresse da semana." },
      { id: 'reversa', category: 'final', min: 60, price: p.reversa, icon: "refresh-cw", tag: isEn ? "REAL CONTACT" : "CONTATO REAL", title: isEn ? "Reverse Massage" : "Massagem Reversa", desc: isEn ? "30 mins of classic massage on you, then you take control and massage me, ending with mutual climax." : "Falta intimidade? 30 minutos de relaxante em você, depois você assume o controle e faz a massagem em mim. Finalizamos e gozamos juntos.", details: isEn ? "Step 1: 30m relaxing massage on you\nStep 2: You massage me\nStep 3: Mutual climax" : "1. Começamos com uma clássica relaxante completa em você no corpo todo (30 minutos).\n2. O controle passa para você: sinta-se à vontade para massagear, tocar e explorar o meu corpo sem pressa.\n3. Pura conexão humana e quebra de barreiras profissionais: o tesão rola solto.\n4. Finalização mútua e troca de calor onde nós dois aproveitamos o gozo juntos." },
      { id: 'nuru', category: 'final', min: 60, price: p.nuru, icon: "star", popular: true, tag: isEn ? "TOTAL SURRENDER" : "ENTREGA TOTAL", title: isEn ? "Nuru Massage" : "Massagem Nuru", desc: isEn ? "Gliding gel, parts of my body sliding over yours." : "Para quando você está no limite. Muito gel deslizando, contato extremo pele com pele e uma experiência intensa que vai fazer suas pernas tremerem no final.", details: isEn ? "Step 1: Full massage\nStep 2: Warm gel\nStep 3: Skin on skin" : "1. Massagem inicial rápida para aquecer e soltar o corpo.\n2. Aplicação de bastante gel especial e quente em nós dois.\n3. Contato total pele na pele: uso partes do meu corpo deslizando sobre o seu.\n4. A viagem final mais prazerosa e intensa para você gozar, relaxar e apagar." },
    ...
    extras: [
      ...
      { id: 'dominador', price: p.extras.dominador, icon: "zap", label: isEn ? "Active Posture (Penetration)" : "Postura Ativa (Com Penetração)", desc: isEn ? "I take full control at the end with penetration, for those who want to surrender." : "Para quem quer se entregar. Eu assumo o controle total no final da sessão com postura ativa e penetração." },
      { id: 'oral', price: p.extras.oral, icon: "heart", label: isEn ? "Oral Included" : "Estímulo Oral", desc: isEn ? "Oral intimacy included in the experience." : "Inclusão de contato quente e direto na boca para maximizar a sua experiência final." },
      ...
      { id: 'prostatico', price: p.extras.prostatico, icon: "star", label: isEn ? "Prostatic Massage" : "Massagem Prostática", desc: isEn ? "Manual prostatic stimulation with lube." : "Estimulação interna focada, feita com os dedos e lubrificante para um clímax totalmente diferente." }
    ],
    faq: [
    ...
    rules: [
      ...
      { icon: "hand", title: isEn ? "Welcoming and Respect" : "Acolhimento e Respeito Mútuo", description: isEn ? "Mutual respect is key." : "Eu me dedico a cuidar de você. Em troca, o respeito deve ser mútuo para que o ambiente seja leve, livre e focado em bem-estar e tesão." },
      { icon: "heart", title: isEn ? "Absolute Surrender" : "Entrega Absoluta", description: isEn ? "Forget the outside world." : "O momento que estamos juntos é só seu. Desligue a mente, os problemas ficam lá fora. O foco agora é apenas sentir e aproveitar ao máximo." },
    ...
    text: {
      ...
      success_title: isEn ? "Request Generated!" : "Pedido Gerado com Sucesso!",
      success_sub: isEn ? "Your session is almost confirmed! Tap the button below to send your request directly to my WhatsApp. I will respond quickly to validate our encounter." : "Seu agendamento está quase confirmado! Toque no botão abaixo para me enviar o seu pedido completo. Eu responderei rapidinho para validarmos o encontro.",
      whatsapp_btn: isEn ? "Send to WhatsApp" : "Enviar Pedido pelo WhatsApp",
      ...
      share_text: isEn ? 'I found the best massage to relieve all stress.' : 'Encontrei o lugar perfeito para uma massagem que tira todo o estresse e traz tesão de verdade.',
...
export default function App() {
  ...
  const generateWhatsAppMsg = () => {
    ...
    else if (booking.locationType === 'motel') locTxt = `🏩 *${isEn ? 'My Suite' : 'Minha Suíte'}*\n⚠️ (${isEn ? 'Address confirmed on WhatsApp' : 'Endereço será confirmado aqui no chat'})`;
    ...
    if (f.rushFee > 0) prices += `\n🚗 *${isEn ? 'Rush Fee' : 'Taxa de Pico'}:* +${formatMoney(f.rushFee, lang)}`;
    prices += `\n\n💰 *${isEn ? 'TOTAL TO PAY' : 'VALOR FINAL'}: ${formatMoney(f.total, lang)}*`;
    
    const mapLink = mapQ ? `\n🔗 *GPS:* https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(mapQ)}` : '';

    const msgPt = `*NOVO AGENDAMENTO EXCLUSIVO* ⚜️ | #${hash}
──────────────────────
Olá Thalyson! Quero confirmar o meu momento de cuidado.

👤 *Nome:* ${sanitizeInput(user.name)}
📅 *Data:* ${dateStr} às ${booking.time}
⏱️ *Tempo Estimado:* ${f.duration} min

💆‍♂️ *O QUE EU ESCOLHI PARA HOJE:*
${servicesText}

${extrasList ? `🔥 *Toques Especiais Adicionados:*\n${extrasList}\n\n` : ''}📍 *LOCAL DO ENCONTRO:*
${locTxt}${mapLink}

${booking.locationType !== 'motel' ? `⚠️ _Ciente de que a taxa de Uber será calculada no chat._\n\n` : ''}🩺 *Saúde:* Declaro estar 100% saudável.

💳 *RESUMO DO INVESTIMENTO:*
${prices}
Forma de Pagamento: *${booking.payment.toUpperCase()}*
──────────────────────
_Li todas as regras e estou pronto para a sessão. Aguardo sua confirmação!_`;

    const msgEn = `*NEW EXCLUSIVE BOOKING* ⚜️ | #${hash}
──────────────────────
Hello Thalyson! I want to confirm my session.

👤 *Name:* ${sanitizeInput(user.name)}
📅 *Date:* ${dateStr} at ${booking.time}
⏱️ *Estimated Time:* ${f.duration} min

💆‍♂️ *WHAT I CHOSE FOR TODAY:*
${servicesText}

${extrasList ? `🔥 *Special Add-ons:*\n${extrasList}\n\n` : ''}📍 *MEETING LOCATION:*
${locTxt}${mapLink}

${booking.locationType !== 'motel' ? `⚠️ _Aware that Uber fee will be calculated in chat._\n\n` : ''}🩺 *Health:* I declare I am 100% healthy.

💳 *INVESTMENT SUMMARY:*
${prices}
Payment Method: *${booking.payment.toUpperCase()}*
──────────────────────
_I have read all rules and am ready for the session. Awaiting confirmation!_`;

    return (isEn ? msgEn : msgPt).trim();
  };
        ...
        <div>
          ...
          {step === 4 && (
            <section className="min-h-[80vh] flex flex-col items-center justify-center text-center animate-scale-in max-w-md mx-auto px-5 pt-12">
              ...
              <div className={`w-full p-6 rounded-[2rem] border mb-8 text-left space-y-4 ${isDark ? 'bg-amber-500/10 border-amber-500/20' : 'bg-amber-50 border-amber-200 shadow-sm'}`}>
                <h4 className={`text-sm font-bold uppercase tracking-widest flex items-center gap-2 ${isDark ? 'text-amber-400' : 'text-amber-600'}`}>
                  <Icon name="alert-circle" size={16} /> Próximos Passos
                </h4>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-zinc-300' : 'text-slate-600'}`}>
                  {lang === 'en' ? 'Clicking the button will open WhatsApp with your booking details. Just hit send, and I will check my schedule, confirm any travel fees, and validate our session.' : 'Ao clicar no botão, o WhatsApp abrirá com todos os detalhes do seu pedido. É só enviar para mim! Vou checar a agenda, confirmar a taxa do Uber (se aplicável) e validar nosso encontro.'}
                </p>
              </div>
