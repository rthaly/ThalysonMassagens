é pra vc mesclar as mudanças com o primeiro codigo que te mandei aqui...n para focar nesse ultimo.. coloque os preços de acordo com gatilho para as pessoas pensarem em comprar
...
// 2. DESIGN SYSTEM & ESTILOS GLOBAIS (UX Minimalista e Elegante)
...
export default function App() {
        ...
        if (draftItemExists && parsed.bookingDraft) {
          ...
          if (draftDate && draftDate > new Date()) {
            ...
            loadedBooking = {
              ...
              // GARENTE QUE EXTRAS NUNCA SEJA UNDEFINED E CRASHE O APP
  ...
  const handleSelectItem = useCallback((type: 'single' | 'pack', item: ServiceItem) => {
    ...
    setTimeout(() => setStep(1), 300); // AVANÇO AUTOMÁTICO UX
  ...
  const financials = useMemo(() => {
    ...
    // PROTEÇÃO CRÍTICA DO OBJECT.KEYS
...
*Sessão condicionada à resposta da equipe de atendimento.*
  ...
  const finishBooking = () => {
    ...
    // ATUALIZAÇÃO SEGURA DO CONTADOR BASEADA NO HISTÓRICO
